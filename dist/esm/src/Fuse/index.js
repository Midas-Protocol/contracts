...
export default class Fuse {
    constructor(web3Provider, chainId) {
        ...
        this.fetchFusePoolData = (poolId, address, coingeckoId) => __awaiter(this, void 0, void 0, function* () {
            ...
            const price = utils.formatEther(
            // prefer rari because it has caching
            yield this.getUsdPriceBN(coingeckoId, true));
            const promises = [];
            const comptrollerContract = new Contract(comptroller, this.chainDeployment.Comptroller.abi, this.provider.getSigner());
    ...
    getUsdPriceBN(coingeckoId = 'ethereum', asBigNumber = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const UsdPrice = (yield axios.get(`https://api.coingecko.com/api/v3/simple/price?vs_currencies=usd&ids=${coingeckoId}`))
    ...
    whitelist // An array of whitelisted addresses
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!implementationAddress) {
                const comptrollerContract = new ContractFactory(this.artifacts.Comptroller.abi, this.artifacts.Comptroller.bytecode, this.provider.getSigner(options.from));
    ...
    deployInterestRateModel(options, model, conf) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const interestRateModelContract = new ContractFactory(modelArtifact.abi, modelArtifact.bytecode, this.provider.getSigner(options.from));
    ...
    deployCEther(conf, options, implementationAddress) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!implementationAddress) {
                const cEtherDelegateFactory = new ContractFactory(this.artifacts.CEtherDelegate.abi, this.artifacts.CEtherDelegate.bytecode, this.provider.getSigner(options.from));
    ...
    deployCErc20(conf, options, implementationAddress // cERC20Delegate implementation
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!implementationAddress) {
                ...
                const cErc20Delegate = new ContractFactory(delegateContractArtifact.abi, delegateContractArtifact.bytecode, this.provider.getSigner(options.from));
    ...
    deployRewardsDistributor(rewardToken, options) {
        return __awaiter(this, void 0, void 0, function* () {
            const distributor = new ContractFactory(this.artifacts.RewardsDistributorDelegator.abi, this.artifacts.RewardsDistributorDelegator.bytecode, this.provider.getSigner());
...
Fuse.SIMPLE_DEPLOY_ORACLES = SIMPLE_DEPLOY_ORACLES;
