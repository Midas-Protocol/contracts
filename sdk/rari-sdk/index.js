...
export default class Rari {
  constructor(web3Provider) {
    ...
    let subpools = {
      ...
      Fuse2: new FuseSubpool(this.web3, {
      ...
      Fuse6: new FuseSubpool(this.web3, {
