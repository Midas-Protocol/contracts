...
const web3_js_1 = require("../utils/web3.js");
...
class DAIInterestRateModelV2 extends JumpRateModel_js_1.default {
    init(interestRateModelAddress, assetAddress, provider) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const interestRateContract = (0, web3_js_1.createContract)(interestRateModelAddress, compound_protocol_min_json_1.contracts["contracts/DAIInterestRateModelV2.sol:DAIInterestRateModelV2"].abi, provider);
            this.dsrPerBlock = (0, web3_js_1.toBN)(yield interestRateContract.callStatic.dsrPerBlock());
            const cTokenContract = (0, web3_js_1.createContract)(assetAddress, compound_protocol_min_json_1.contracts["contracts/CTokenInterfaces.sol:CTokenInterface"].abi, provider);
            this.cash = (0, web3_js_1.toBN)(yield cTokenContract.callStatic.getCash());
            this.borrows = (0, web3_js_1.toBN)(yield cTokenContract.callStatic.totalBorrowsCurrent());
            this.reserves = (0, web3_js_1.toBN)(yield cTokenContract.callStatic.totalReserves());
        });
    }
    _init(interestRateModelAddress, reserveFactorMantissa, adminFeeMantissa, fuseFeeMantissa, provider) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const interestRateContract = (0, web3_js_1.createContract)(interestRateModelAddress, compound_protocol_min_json_1.contracts["contracts/DAIInterestRateModelV2.sol:DAIInterestRateModelV2"].abi, provider);
            this.dsrPerBlock = (0, web3_js_1.toBN)(yield interestRateContract.callStatic.dsrPerBlock());
            this.cash = (0, web3_js_1.toBN)(0);
            this.borrows = (0, web3_js_1.toBN)(0);
            this.reserves = (0, web3_js_1.toBN)(0);
        });
    }
    __init(baseRatePerBlock, multiplierPerBlock, jumpMultiplierPerBlock, kink, reserveFactorMantissa, adminFeeMantissa, fuseFeeMantissa) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this.dsrPerBlock = (0, web3_js_1.toBN)(0); // TODO: Make this work if DSR ever goes positive again
            this.cash = (0, web3_js_1.toBN)(0);
            this.borrows = (0, web3_js_1.toBN)(0);
            this.reserves = (0, web3_js_1.toBN)(0);
        });
