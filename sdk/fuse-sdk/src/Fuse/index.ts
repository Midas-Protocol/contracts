  ...
  constructor(web3Provider: JsonRpcProvider | Web3Provider, contractConfig: contractConfig) {
    ...
    this.deployPool = async function (
      ...
      if (!implementationAddress) {
        const comptrollerContract = new ContractFactory(
          JSON.parse(this.compoundContractsMini["contracts/Comptroller.sol:Comptroller"].abi),
    ...
    this.deployComptroller = async function (
      ...
      if (!implementationAddress) {
        const comptrollerContract = new Contract(
          JSON.parse(this.compoundContractsMini["contracts/Comptroller.sol:Comptroller"].abi),
          this.compoundContractsMini["contracts/Comptroller.sol:Comptroller"].bin,
          this.provider.getSigner()
        );
      ...
      const unitrollerContract = new ContractFactory(
        JSON.parse(this.compoundContractsMini["contracts/Unitroller.sol:Unitroller"].abi),
        this.compoundContractsMini["contracts/Unitroller.sol:Unitroller"].bin,
        this.provider.getSigner()
      );
    ...
    this.deployInterestRateModel = async function (model: string, conf: interestRateModelParams, options: any) {
      ...
      const interestRateModelContract = new ContractFactory(
        JSON.parse(this.compoundContractsMini["contracts/" + model + ".sol:" + model].abi),
        this.compoundContractsMini["contracts/" + model + ".sol:" + model].bin,
        this.provider.getSigner()
      );
    ...
    this.deployCEther = async function (
      ...
      if (!implementationAddress) {
        const cEtherDelegateFactory = new ContractFactory(
          JSON.parse(this.compoundContractsMini["contracts/CEtherDelegate.sol:CEtherDelegate"].abi),
          this.compoundContractsMini["contracts/CEtherDelegate.sol:CEtherDelegate"].bin,
          this.provider.getSigner()
        );
      ...
      const byteCodeHash = utils.keccak256(
        "0x" + this.compoundContractsMini["contracts/CEtherDelegator.sol:CEtherDelegator"].bin
      );
    ...
    this.deployCErc20 = async function (
      ...
      if (!implementationAddress) {
        ...
        const cErc20Delegate = new ContractFactory(
          JSON.parse(
            this.compoundContractsMini["contracts/" + conf.delegateContractName + ".sol:" + conf.delegateContractName]
              .abi
          ),
          this.compoundContractsMini[
    ...
    this.getInterestRateModel = async function (assetAddress: string): Promise<any | undefined> {
      ...
      const assetContract = new Contract(
        assetAddress,
        JSON.parse(this.compoundContractsMini["contracts/CTokenInterfaces.sol:CTokenInterface"].abi),
        this.provider
      );
        ...
        try {
          ...
          try {
            ...
            const underlyingToken = new Contract(
              conf.underlying,
              JSON.parse(this.compoundContractsMini["contracts/EIP20Interface.sol:EIP20Interface"].abi),
              this.provider
            );
    ...
    this.deployRewardsDistributor = async function (rewardToken, options) {
      const distributor = new ContractFactory(
        JSON.parse(
          this.compoundContractsMini["contracts/RewardsDistributorDelegator.sol:RewardsDistributorDelegator"].abi
        ),
        this.compoundContractsMini["contracts/RewardsDistributorDelegator.sol:RewardsDistributorDelegator"].bin,
        this.provider.getSigner()
      );
