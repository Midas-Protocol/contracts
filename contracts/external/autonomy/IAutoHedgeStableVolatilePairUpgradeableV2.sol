...
import { IFlashloanWrapper } from "./IFlashloanWrapper.sol";
import { IAutoHedgeStableVolatileFactoryUpgradeableV2 } from "./IAutoHedgeStableVolatileFactoryUpgradeableV2.sol";
...
interface IAutoHedgeStableVolatilePairUpgradeableV2 {
  ...
  event Withdrawn(address indexed user, uint256 amountStableToUser, uint256 amountVolToRepay, uint256 amountBurned);
  ...
  function newPath(IERC20Metadata src, IERC20Metadata dest) external pure returns (address[] memory);
