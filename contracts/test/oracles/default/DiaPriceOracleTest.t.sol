...
contract DiaPriceOracleTest is BaseTest {
    ...
    function setUpOracles() public {
        DIAOracleV2 ethPool = DIAOracleV2(
            0x1f1BAe8D7a2957CeF5ffA0d957cfEDd6828D728f
        );
        address[] memory underlyings = new address[](1);
    ...
    function testDiaPriceOracleWithNativeFeed()
        public
        shouldRun(forChains(MOONBEAM_MAINNET))
    {
        ...
        assertEq(price, 373055371852000000000);
    }

    function testDiaPriceOracleWithMasterPriceOracle()
        public
        shouldRun(forChains(MOONBEAM_MAINNET))
    {
