...
import { AnkrCertificateInterestRateModel, IAnkrCertBond } from "../../midas/irms/AnkrCertificateInterestRateModel.sol";
...
contract InterestRateModelTest is BaseTest {
  ...
  AnkrCertificateInterestRateModel ankrCertificateInterestRateModelFTM;
  ...
  function testAnkrFTMBorrowModelRate() internal {
    vm.mockCall(
      address(ANKR_FTM_R),
      abi.encodeWithSelector(IAnkrCertBond.getRatioHistory.selector, day),
      abi.encode(5.12e18)
    );
