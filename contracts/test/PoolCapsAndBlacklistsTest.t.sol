...
contract PoolCapsAndBlacklistsTest is MarketsTest {
  ...
  ICToken ankrBNBAnkrMkt = ICToken(0x71693C84486B37096192c9942852f542543639Bf);
  ICToken ankrBNBMkt = ICToken(0xb2b01D6f953A28ba6C8f9E22986f5bDDb7653aEa);
  ...
  function testSupplyCapWhitelist() public fork(BSC_MAINNET) {
    ...
    ICToken[] memory markets = new ICToken[](2);
    markets[0] = ICToken(address(ankrBNBMkt));
    markets[1] = ICToken(address(ankrBNBAnkrMkt));
