...
//}
//
//contract AlgebraSwapFunder is IRedemptionStrategy {
...
//    (address _outputToken, ISwapRouter swapRouter) = abi.decode(strategyData, (address, ISwapRouter));
//
//    IAlgebraPool pair = IAlgebraPool(_outputToken);
//
...
//    }
//
//    function _swapAndStake(IBeefyVaultV6 vault, IUniswapV2Pair pair, uint256 tokenAmountOutMin, address tokenIn) private {
//        (uint256 reserveA, uint256 reserveB,) = pair.getReserves();
//        require(reserveA > minimumAmount && reserveB > minimumAmount, 'Beefy: Liquidity pair reserves too low');
//
//        bool isInputA = pair.token0() == tokenIn;
