...
contract AnkrFTMInterestRateModel is InterestRateModel {
   ...
   * @param _aftmr Address for Ankr BNB stacking rate
   */
  constructor(
  ...
  function getAnkrRate() public view returns (uint256) {
    return uint256(IAnkrFTMR(ANKR_FTM_R).getRatioHistory(day)).div(100).div(blocksPerYear);
  }
